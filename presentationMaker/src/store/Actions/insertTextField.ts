...
function insertTextField(editor: EditorType, {slideId}: {slideId: string}): EditorType {
    ...
    if (searchedSlide !== undefined){
        ...
        const textObjectForSlide: TextObject = { id: textId, position: {X: 150, Y: 300}, text: 'New Text', fontsize: 16, font: 'arial', type: 'text'}
